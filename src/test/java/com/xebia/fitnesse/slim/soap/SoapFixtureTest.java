...
public class SoapFixtureTest {
    ...
    public void shouldCreateNewContent() throws Throwable {
        ...
        assertXml("<ns:child xmlns:ns=\"a\">value</ns:child>", SoapFixture.MessagePartType.BODY);
    }
    ...
    public void shouldAddSubFieldsToSameContainer() throws Throwable {
        ...
        assertXml("<child><field1>value1</field1><field2>value2</field2></child>", SoapFixture.MessagePartType.BODY);
    }

    @Test
    public void shouldHandleArray() throws Throwable {
        soapFixture.setXPathValue("child[1]/field", "value");
        assertXml("<child><field>value</field></child>", SoapFixture.MessagePartType.BODY);
        soapFixture.setXPathValue("child[2]/field", "value");
        assertXml("<child><field>value</field></child><child><field>value</field></child>", SoapFixture.MessagePartType.BODY);
    }

    @Test
    public void shouldHandleValuesInHeader() throws Throwable {
        soapFixture.addPrefixNamespace("req", "http://example.com/namespace");
        soapFixture.setXPathInHeaderValue("req:child[1]/req:field", "value");
        assertXml("<req:child xmlns:req=\"http://example.com/namespace\"><req:field>value</req:field></req:child>", SoapFixture.MessagePartType.HEADER);
    }
    ...
    public void shouldAcceptIndexJumps() throws Exception {
        ...
        assertXml("<child/><child/><child/><child/><child/><child/><child/><child/><child><field>value</field></child>", SoapFixture.MessagePartType.BODY);
    }

    @Test
    public void shouldParseIndexCorrectly() throws Exception {
        soapFixture.setXPathValue("child[10]/field", "value");
        assertXml("<child/><child/><child/><child/><child/><child/><child/><child/><child/><child><field>value</field></child>", SoapFixture.MessagePartType.BODY);
    }

    @Test
    public void shouldHandleAttribute() throws Throwable {
        soapFixture.setXPathValue("child/@attributename", "value");
        assertXml("<child attributename=\"value\"/>", SoapFixture.MessagePartType.BODY);
    }
    ...
    public void shouldHandleAttributeWithNamespace() throws Throwable {
        ...
        assertXml("<child xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:attributename=\"value\"/>", SoapFixture.MessagePartType.BODY);
    }
    ...
    public void shouldHandleAttributeWithNamespaceInElementWithNamespace() throws Throwable {
        ...
        assertXml("<req:child xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:attributename=\"value\" xsi:other=\"someother\" xmlns:req=\"http://example.com/namespace\"/>", SoapFixture.MessagePartType.BODY);
    }

    private void assertXml(String xml, SoapFixture.MessagePartType messagePartType) throws TransformerException, SOAPException, IOException {
        switch (messagePartType) {
            case HEADER:
                assertThat(soapFixture.requestHeader(), is(xml));
                break;
            case BODY:
                assertThat(soapFixture.request(), is(xml));
                break;
            case FULL:
                assertThat(soapFixture.fullRequest(), is(xml));
                break;
        }
    }
